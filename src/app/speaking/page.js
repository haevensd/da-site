  ...
  return (
    <div style={styles.container}>
        ...
        <div className="speaking" style={{paddingLeft: '30px',paddingRight: '30px',minHeight: '1000px',display: 'flex', flexDirection: 'column',alignItems: 'center',backgroundImage: 'url("/stage.jpg")', backgroundRepeat: 'no-repeat', backgroundPositionY: '38%',backgroundSize: 'cover',paddingBottom: '100px'}}>
            ...
            <h3 className="subtitle" style={{maxWidth: '860px',fontSize: '20px',textAlign:'center', color: 'white',marginBottom: '50px', marginTop: '10px', }}>If you’ve got a speaking opportunity or aligned stage that you think I’m the right fit for, this is the place for you to send the request.</h3>
