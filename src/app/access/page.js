...
const CoursePlayer = () => {
  ...
  return (
    <div className="course-player-container">
      {!mobileSidebarClosed && <img className="arrow" onClick={() => setMobileSidebarClosed(!mobileSidebarClosed)} style={{position:'absolute', top: '30px',zIndex: 1000, left: '20px', marginBottom: '1rem', transform: 'rotate(180deg)'}} width={15} height={20} src="/chevron-left.png"></img>}
